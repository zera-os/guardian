...
void ThreadPool::setNumThreads(size_t numThreads)
{
    ...
    std::cout << "Initializing ThreadPool with " << std::to_string(numThreads) << " threads." << std::endl;
...
void ThreadPool::workerThread()
{
    while (true)
    {
        ...
        {
            std::cout << "Exception in task: " << e.what() << std::endl;
        }
        catch (...)
        {
            std::cout << "Unknown exception in task." << std::endl;
        }
    }
}
...
void ValidatorThreadPool::setNumThreads(size_t numThreads)
{
    ...
    std::cout << "Initializing ValidatorThreadPool with " << std::to_string(numThreads) << " threads." << std::endl;
